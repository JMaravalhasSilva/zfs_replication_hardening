...
For each dataset you wish to replicate, you must allow the user zfs_replication to run "zfs send":
"zfs allow -u zfs_replication send DATASET_NAME"
Example:
"zfs allow -u zfs_replication send Data/my_dataset"
